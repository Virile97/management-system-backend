...
CREATE TABLE IF NOT EXISTS "soul_winners" (
    ...
    CONSTRAINT "soul_winners_pkey" PRIMARY KEY ("soulWinId", "memberId")
);

-- Backfill existing single-winner rows.
INSERT INTO "soul_winners" ("soulWinId", "memberId", "sortOrder", "createdAt")
...
CREATE INDEX IF NOT EXISTS "soul_winners_memberId_soulWinId_idx"
  ON "soul_winners"("memberId", "soulWinId");

CREATE INDEX IF NOT EXISTS "soul_wins_event_idx" ON "soul_wins"("event");

ALTER TABLE "soul_winners"
  DROP CONSTRAINT IF EXISTS "soul_winners_soulWinId_fkey";
ALTER TABLE "soul_winners"
  ADD CONSTRAINT "soul_winners_soulWinId_fkey"
  FOREIGN KEY ("soulWinId") REFERENCES "soul_wins"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "soul_winners"
  DROP CONSTRAINT IF EXISTS "soul_winners_memberId_fkey";
ALTER TABLE "soul_winners"
  ADD CONSTRAINT "soul_winners_memberId_fkey"
